...
@app.route('/search-doctors-hms', methods=['GET', 'POST'])
...
def book_appointment(doctor_id):
    ...
    if request.method == 'POST':
        ...
        selected_date = datetime.datetime.strptime(appointment_date, '%d/%m/%Y').date()
        ...
        appointment_time_mysql = datetime.datetime.strptime(appointment_time, '%I:%M %p').strftime('%H:%M:%S')
...
def payment(doctor_id):
    ...
    if request.method == 'POST':
        ...
        msg.body = f"Dear {name},\n\nThank you for booking an appointment with Healthcare Management System (HMS).\n\nYour appointment details are as follows:\n\nDoctor: {doctor_name}\nAppointment Date: {appointment_date}\nAppointment Time: {appointment_time}\n\nWe look forward to seeing you!\n\nBest regards,\nThe PMS Team"
        mail.send(msg)
...
def patient_register():
    if request.method == 'POST':
        ...
        print(full_name, email, phone_no, password)
